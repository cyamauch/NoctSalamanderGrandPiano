...
if [ "$KEY" = "F#1" ]; then
  ...
  # Seek
  #            v1    v2    v3    v4    v5    v6    v7    v8    v9   v10   v11   v12   v13   v14   v15   v16
  SEEK_ALL="0.008 0.010 0.004 0.008 0.011 0.008 0.006 0.009 0.007 0.008 0.008 0.007 0.008 0.012 0.012 0.009"
  ...
  ATACK_VOL="-4.5dB -7.5dB -4.0dB -3.5dB -3.4dB -3.3dB -3.2dB -3.2dB -2.5dB -2.5dB -2.5dB -2.5dB -2.5dB -2.5dB -2.5dB -2.5dB"
  #
  #HPASS_VOL="     0      0      0  -36dB  -18dB  -16dB  -15dB  -15dB  -12dB  -10dB -9.0dB -9.0dB -9.0dB -9.0dB -9.0dB -9.0dB"
  HPASS_VOL="  -16dB  -20dB  -40dB  -36dB  -28dB  -24dB  -24dB  -24dB  -24dB -22dB -20.0dB -18.0dB -16.0dB -14.0dB -14.0dB -14.0dB"
  ...
  rm -f _tmp_sub_seek.wav _tmp_sub_0.wav _tmp_sub_1.wav _tmp_sub_2.wav _tmp_sub_3.wav _tmp_sub_4.wav _tmp_sub_5.wav $OUT_FILE
  "$FFMPEG" -i $IN_FILE -ss $SEEK -c:a pcm_f32le _tmp_sub_seek.wav
  # Fix overtone and envelope of attack
  "$FFMPEG" -i _tmp_sub_seek.wav -af afade=t=in:st=0:d=0.4:silence=0.45:curve=tri,volume=+3.0dB -c:a pcm_f32le _tmp_sub_0.wav
  "$FFMPEG" -i _tmp_sub_seek.wav -af afade=t=out:st=0:d=0.4:silence=0.0:curve=tri,highpass=f=${A_FRQ}:t=q:w=0.707:r=f32,volume=${A_VOL} -c:a pcm_f32le _tmp_sub_1.wav
  "$FFMPEG" -i _tmp_sub_0.wav -i _tmp_sub_1.wav -filter_complex "amix=normalize=0" -c:a pcm_f32le _tmp_sub_2.wav

  # Fix attack #2
  "$FFMPEG" -i _tmp_sub_seek.wav -af afade=t=out:st=0:d=0.15:silence=0.0:curve=tri,volume=-20.0dB -c:a pcm_f32le _tmp_sub_3.wav
