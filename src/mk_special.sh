...
if [ "$KEY" = "F#1" ]; then
  ...
  "$FFMPEG" -i _tmp_sub_seek.wav -af equalizer=f=1439:t=h:w=8:g=-40:r=f32,equalizer=f=2176:t=h:w=8:g=-40:r=f32,equalizer=f=1665:t=h:w=1665:g=${GAIN1665}:r=f32,equalizer=f=55:t=h:w=55:g=${GAIN55}:r=f32,equalizer=f=238:t=h:w=238:g=${GAIN238},afade=t=out:st=0:d=0.5:silence=0.0:curve=tri -c:a pcm_f32le _tmp_sub_0.wav
  "$FFMPEG" -i _tmp_sub_seek.wav -af equalizer=f=1665:t=h:w=1665:g=${GAIN1665}:r=f32,equalizer=f=55:t=h:w=55:g=${GAIN55}:r=f32,equalizer=f=238:t=h:w=238:g=${GAIN238},afade=t=in:st=0:d=0.5:silence=0.0:curve=tri -c:a pcm_f32le _tmp_sub_1.wav
  ...
  "$FFMPEG" -i _tmp_sub_seek.wav -af afade=t=out:st=0:d=0.8:silence=0.0:curve=tri,equalizer=f=1116.0:t=h:w=1.0:g=-80:r=f32,volume=-0.3dB -c:a pcm_f32le _tmp_sub_1.wav
  "$FFMPEG" -i _tmp_sub_0.wav -i _tmp_sub_1.wav -filter_complex "amix=normalize=0" -c:a pcm_f32le _tmp_sub_2.wav
  # Enhance overtone
  ...
  #            v1    v2    v3    v4    v5    v6    v7    v8    v9   v10   v11   v12   v13   v14   v15   v16
  SEEK_ALL="0.008 0.010 0.004 0.008 0.011 0.008 0.006 0.009 0.007 0.008 0.008 0.007 0.008 0.012 0.009 0.010"
  ...
  #            v1     v2     v3     v4     v5     v6     v7     v8     v9    v10    v11    v12    v13    v14    v15    v16
  INPUT_VOL="+0.5dB -0.7dB -2.2dB -3.0dB -2.8dB -2.8dB -3.2dB -2.9dB -4.2dB -3.6dB -4.0dB -4.0dB -4.3dB -4.2dB -5.9dB -5.0dB"
  I_VOL=`echo $VEL $INPUT_VOL | awk '{ split($0,ARR," "); print ARR[1 + ARR[1]]; }'`
  ...
  #### overtone G5 (783.991)
  #### overtone D6(1174.659Hz), E6 (1318.51Hz), G6(1567.982Hz), A6(1760)
  ####          A#6(1864.655Hz), B6(1975.533Hz), D7(2349.318Hz)
  ####
  ...
  #########       v1     v2     v3     v4     v5     v6     v7     v8     v9    v10    v11    v12    v13    v14    v15    v16
  OVTONE_VOL="  +0.0   +1.0   +0.0   +2.4   +2.5   +2.6   +2.7   +2.8   +3.0   +3.1   +3.2   +3.2   +3.3   +3.5   +3.5   +3.5"
  #
  OV_VOL=`echo $VEL $OVTONE_VOL | awk '{ split($0,ARR," "); print ARR[1 + ARR[1]]; }'`

  # param [500,1200] of ARG_EQ_MID is very critical !!!
  ##ARG_EQ_MID="equalizer=f=525.0:t=h:w=1100.0:g=${OV_VOL}:r=f32"
  ARG_EQ_MID="equalizer=f=500.0:t=h:w=1200.0:g=${OV_VOL}:r=f32"
  #ARG_EQ_MID="equalizer=f=475.0:t=h:w=1300.0:g=${OV_VOL}:r=f32"
  #ARG_EQ_MID="equalizer=f=450.0:t=h:w=1400.0:g=${OV_VOL}:r=f32"
  #ARG_EQ_MID="equalizer=f=425.0:t=h:w=1500.0:g=${OV_VOL}:r=f32"

  ##ARG_EQ_HIGH="equalizer=f=1200.0:t=h:w=100.0:g=+10:r=f32"
  ##ARG_EQ_HIGH="equalizer=f=1200.0:t=h:w=100.0:g=+10:r=f32,equalizer=f=1568.0:t=h:w=50.0:g=-12:r=f32,equalizer=f=1864.7:t=h:w=50.0:g=-20:r=f32"
  ARG_EQ_HIGH="equalizer=f=1200.0:t=h:w=100.0:g=+10:r=f32,equalizer=f=1760.0:t=h:w=50.0:g=-12:r=f32,equalizer=f=1864.7:t=h:w=50.0:g=-24:r=f32"
  ...
  "$FFMPEG" -i $PCM_IN -af afade=t=in:st=${T_ST_0}:d=${T_D_0}:silence=${FACTOR_REDUCE}:curve=tri,equalizer=f=${EQ_F}:t=h:w=${EQ_W}:g=-33.0:r=f32,volume=+0.5dB -c:a pcm_f32le _tmp_sub_6.wav
  ...
  #########      v1     v2     v3     v4     v5     v6     v7     v8     v9    v10    v11    v12    v13    v14    v15    v16
  ATACK_VOL="  +4.0   +1.5   +2.5   +4.7   +4.8   +4.9   +5.0   +5.1   +5.3   +5.5   +6.0   +7.0   +7.0   +7.0   +7.0   +7.0"
  #
  ...
  #########      v1     v2     v3     v4     v5     v6     v7     v8     v9    v10    v11    v12    v13    v14    v15    v16
  HPASS_VOL=" -12dB  -30dB  -5.5dB -2.9dB -2.8dB -2.7dB -2.6dB -2.5dB  -1dB   -0dB   -0dB   -0dB   -0dB   -0dB   -0dB   -0dB"
